...
* [x] Verify that you have LESS installed correctly by running `lessc -v` in your terminal, if you don't getxa version message back, reach out to your project manager for help.
